...
public final class DocumentLookupResult {
    ...
    public static final class PreMaterialized extends Engine.GetResult {
        ...
        public Engine.Searcher searcher() {
            throw new UnsupportedOperationException("PreMaterialized has no Lucene searcher — use lookup()");
        }

        @Override
        public DocIdAndVersion docIdAndVersion() {
            throw new UnsupportedOperationException("PreMaterialized has no docId — use lookup()");
        }
